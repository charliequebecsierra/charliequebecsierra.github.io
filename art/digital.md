...
- { filename: "../img/digital/pickles.png", text: "Garlic Dill Pickle Chips: jar label for home canning, vector art"}
- { filename: "../img/digital/strawberry_jam.png", text: "Strawberry Jam: jar label for home canning, vector art"}
thumbnail_image: ../img/digital/digital_thumbnail.png
---
